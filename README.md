...
| 文档 | 说明 |
|------|------|
| [系统架构全景](docs/ARCHITECTURE.md) | 30 秒理解全貌，定位所需文档 |
| [完整复现指南](docs/REPRODUCE.md) | 从零重建前后端系统 |
| [后端设计系统](docs/BACKEND.md) | API + 数据库 + MCP 完整规格 (1259 行) |
| [前端设计系统](docs/FRONTEND.md) | 组件 + 样式 + 路由完整规范 (1110 行) |
| [图谱架构](docs/GRAPH.md) | 三视图视觉编码 + 重构历史 (710 行) |
| [AI 协作能力](docs/AI-CAPABILITIES.md) | MCP 工具 + Skill + CIDED 决策框架 |
